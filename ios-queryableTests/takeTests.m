...
- (void)test_take_takes_records
{
    ...
    XCTAssertEqual(products.count, (NSUInteger)2, @"The wrong number of objects was returned");
    XCTAssertEqualObjects(firstProduct.name, @"Apple", @"Expected a product name of Apple");
}
...
- (void)test_take_negative_amount_returns_no_records
{
    ...
    XCTAssertEqual(products.count, (NSUInteger)0, @"The wrong number of objects was returned");
}
